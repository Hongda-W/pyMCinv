...
ind = int(sys.argv[1])
NMS = 'S'
outname = "JdF_Profile_temp_both/water_%s%g.mod"%(NMS,ind)
...
sed_c = 0.48
crust_thk = 7.
outdisp_ph = "JdF_Profile_temp_both/%s%g_disp_ph.txt"%(NMS,ind)
outdisp_gr = "JdF_Profile_temp_both/%s%g_disp_gr.txt"%(NMS,ind)
...
if __name__ == "__main__":
    ...
    outfile.write("3 6 {} 3 {} {} {} 1.76".format(mant_thk,age,1325.,15.))
    outfile.close()
