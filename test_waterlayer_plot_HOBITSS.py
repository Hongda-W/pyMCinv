...
vpr.plot_hist(pindex=5, bins=50, title='Water thickness', xlabel='thickness (km)', priori=True, p_name=p_name, minline=False, showfig=False)
vpr.plot_hist(pindex=6, bins=50, title='Sediment thickness', xlabel='thickness (km)', priori=True, p_name=p_name, minline=False, showfig=False)
vpr.plot_hist(pindex=7, bins=50, title='Crust thickness', xlabel='thickness (km)', priori=True, p_name=p_name, minline=False, showfig=True)
