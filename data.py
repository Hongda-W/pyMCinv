...
class disp(object):
    ...
    def get_gmisfit(self):
        ...
        if temp != temp: # sometime the forward inversion will give nan for group velocities
            temp = 99.
    ...
    def get_misfit(self):
        ...
        if self.isgroup:
            ...
            if temp2 != temp2: # sometime the forward inversion will give nan for group velocities
                temp2 = 99. # set the difference between data and model to be large
            tS          = temp2
            self.gS     = tS
